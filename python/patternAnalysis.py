...
new_set = pd.DataFrame({'emotion':emotion,'organization':organization,'instruction':instruction,'Whole_Class':classScore['Whole_Class'],'Individual':classScore['Individual'],'Multiple':classScore['Multiple'],'Peers':classScore['Peers'],'Task':classScore['Task']})
...
new_set_format.to_csv("../data/new_set.csv", index=False)
pearson_new_set.to_csv("../data/pearson_new_set.csv", index=False)
spearman_new_set.to_csv("../data/spearman_new_set.csv", index=False)
